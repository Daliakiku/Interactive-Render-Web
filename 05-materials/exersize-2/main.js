...
const material = new THREE.MeshToonMaterial({flatShading: true, specular: "white", shininess: 100}); //can be left blank
...
const topLight = new THREE.PointLight("red", 100, 100);
topLight.position.y = 5;
scene.add(topLight);

const frontLight = new THREE.PointLight("blue", 1000, 100);
